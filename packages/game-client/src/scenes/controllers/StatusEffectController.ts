...
import type { Unit, GameState } from '@battlegame/game-core';
import type { ResolvedTarget, TriggerType, AbilityDefinition } from '@battlegame/game-core';
import { EffectResolver } from '@battlegame/game-core';
